...
$config['authentication'] = function() use ($fck_connector_config) {
	if($fck_connector_config->Enabled) {return true;}
return false;
};
...
$config['licenseName'] = "masterflash.ru";
$config['licenseKey']  = '5SR6NQXYFP9UJS4TYP149FBWPQ113Y4W';
...
$config['images'] = array(
    ...
    'sizes' => array(
        ...
        'medium' => array('width' => 600, 'height' => 480, 'quality' => 95),
        'large'  => array('width' => 800, 'height' => 600, 'quality' => 95)
    )
);
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => trim($fck_connector_config->FileTypesPath_File,"/"),
    'maxSize'           => 0,
...
$config['resourceTypes'][] = array(
    'name'              => 'Images',
    'directory'         =>  trim($fck_connector_config->FileTypesPath_Image,"/"),
    'maxSize'           => 0,
